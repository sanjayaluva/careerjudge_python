  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        {settings?.cancellation_refund_policy && (
...
function SessionActionsForCounselee({ session }: { session: CounselingSession }) {
  ...
  const [fb, setFb] = useState<{
    session_useful: SessionFeedback["session_useful"];
    useful_reason: string;
    counsellor_empathy: SessionFeedback["counsellor_empathy"];
    session_ended: SessionFeedback["session_ended"];
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <textarea
                ...
                value={fb.useful_reason}
                onChange={set("useful_reason")}
              />
            </div>
            {/* 3 */}
            <div>
            ...
            <div>
              ...
              <textarea
                rows={2}
                className="w-full rounded-md border border-slate-200 px-3 py-2 text-sm"
                value={fb.rechoose_reason}
                onChange={set("rechoose_reason")}
              />
            </div>
            {/* 7 */}
            <div>
