...
export const MODULE_VISIBILITY: Record<RoleName, ModuleKey[]> = {
  ...
  corp_admin: ["dashboard", "profile", "users", "organizations", "assessments", "reports", "training"],
  corp_exclusive: [
    "dashboard",
    "profile",
    "users",
  ...
  psychometrician: ["dashboard", "profile", "question_bank", "assessments", "career_profiling", "reports"],
  ...
  individual: ["dashboard", "profile", "assessments", "career_profiling", "reports", "training", "counseling"],
};
...
export const NAV_ITEMS: NavItem[] = [
  { key: "dashboard", label: "Dashboard", to: "/dashboard", icon: "LayoutDashboard", roles: roleListFor("dashboard") },
  { key: "profile", label: "Profile", to: "/profile", icon: "UserCircle", roles: roleListFor("profile") },
  { key: "users", label: "Users", to: "/admin/users", icon: "Users", roles: roleListFor("users") },
  { key: "roles", label: "Roles & Permissions", to: "/admin/roles", icon: "ShieldCheck", roles: roleListFor("roles") },
  { key: "organizations", label: "Organizations", to: "/organizations", icon: "Building2", roles: roleListFor("organizations") },
  { key: "question_bank", label: "Question Bank", to: "/question-bank", icon: "BookOpen", roles: roleListFor("question_bank") },
  { key: "assessments", label: "Assessments", to: "/assessments", icon: "ClipboardList", roles: roleListFor("assessments") },
  { key: "career_profiling", label: "Career Profiling", to: "/career-profiling", icon: "Compass", roles: roleListFor("career_profiling") },
  { key: "reports", label: "Reports", to: "/reports", icon: "BarChart3", roles: roleListFor("reports") },
  { key: "training", label: "Training", to: "/training", icon: "GraduationCap", roles: roleListFor("training") },
  { key: "counseling", label: "Counseling", to: "/counseling", icon: "MessageSquare", roles: roleListFor("counseling") },
